...
<a href="QuestionUpload.jsp" class="logoutbtn2"><button class="Btnshowlist">Question Upload</button></a>
	...
	<a href="UserList" class="logoutbtn2"><button class="Btnshowlist active">User Lists</button></a>
	...
	<p class="queslist">User Count :   ${ucount}</p>
		<tr class="headen">
			<td>Id</td>
...
<c:forEach items="${userlist}" var="que" varStatus="status">
		<tr class="whitening">
			<td>${que.id}</td>
			<td class="title">${que.email}</td>
			<td >${que.fullname}</td>
		</tr>
</c:forEach>
