...
<body>
	...
	<form action="ShowQuestionList" method="post" class="logoutbtn2"><button class="Btnshowlist">QuestionList</button></form>
      ...
      <form action="ShowQuestionCodeList" method="post" class="logoutbtn2"><button class="Btnshowlist active">QuestionCode List</button></form>
	...
	<table>
		<p class="checknoti"> ${noti}</p>

		<tr class="headen">
			<td>Question Count</td>
			<td>Subject_id</td>
			<td class="title">QuestionCode</td>
			<td >Subjects</td>
			<td>Edit</td>
		</tr>
...
<c:forEach items="${questionlist}" var="que" varStatus="status">
		<tr class="whitening">
			...
			<td>${que.subject_id}</td>
			<td class="title">${que.questioncode}</td>
			<td >${que.subject}</td>
			<td class="delete"><a href="EditDelete?action=Delete&code=${que.questioncode}&id=${que.subject_id}">Delete</a></td>
		</tr>
</c:forEach>
